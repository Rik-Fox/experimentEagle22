...
img = visual.ImageStim(win: Any, image: Any | None = None, mask: Any | None = None, units: str = "", pos: Any = (0, 0), size: Any | None = None, anchor: str = "center", ori: float = 0, color: Any = (1, 1, 1), colorSpace: str = 'rgb', contrast: float = 1, opacity: Any | None = None, depth: int = 0, interpolate: bool = False, flipHoriz: bool = False, flipVert: bool = False, texRes: int = 128, name: Any | None = None, autoLog: Any | None = None, maskParams: Any | None = None))
...
for thisTrial in trials:
    ...
    trialComponents = [slider, slider_2, textbox, text]
