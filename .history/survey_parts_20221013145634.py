...
img = visual.ImageStim(win: Any, image=, mask=, units: str = "", pos: Any = (0, 0), size=, anchor: str = "center", ori: float = 0, color: Any = (1, 1, 1), colorSpace: str = 'rgb', contrast: float = 1, opacity=, depth: int = 0, interpolate: bool = False, flipHoriz: bool = False, flipVert: bool = False, texRes: int = 128, name=, autoLog=, maskParams=)
