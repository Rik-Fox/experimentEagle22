...
img = visual.ImageStim(win=, image=, mask=, units: str = "", pos= (0, 0), size=, anchor= "center", ori = 0, color = (1, 1, 1), colorSpace: str = 'rgb', contrast: float = 1, opacity=, depth: int = 0, interpolate: bool = False, flipHoriz: bool = False, flipVert: bool = False, texRes: int = 128, name=, autoLog=, maskParams=)
