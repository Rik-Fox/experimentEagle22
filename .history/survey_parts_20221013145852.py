...
img = visual.ImageStim(win=win, image="", mask=None, units = "", pos= (0, 0), size=None, anchor= "center", ori = 0, color = (1, 1, 1), colorSpace = 'rgb', contrast = 1, opacity=, depth = 0, interpolate = False, flipHoriz = False, flipVert = False, texRes = 128, name="", autoLog=None, maskParams=None
                       )
